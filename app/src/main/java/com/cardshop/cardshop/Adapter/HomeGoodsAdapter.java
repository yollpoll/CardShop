...
public class HomeGoodsAdapter extends FooterAdapter<List<GoodsModule>, BaseViewHolder> {
    private List<GoodsModule> list;
    private Context context;
    private OnItemClickListener onItemClickListener;

    public HomeGoodsAdapter(List<GoodsModule> list, OnItemClickListener onItemClickListener) {
        super(list);
